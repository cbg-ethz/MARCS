# changed "clustGraph" to "clustNet"
...
get_classification <- function(cluster_results, data_classify){
  ...
  # assign cluster
  newallrelativeprobabsnotau <- clustNet:::allrelativeprobs(scoresagainstclusters)
  newallrelativeprobabs <- clustNet:::relativeprobswithtau(newallrelativeprobabsnotau,tauvec)

  newclustermembership<-clustNet:::reassignsamples(newallrelativeprobabs)
